...
const variantStyles = {
  primary:
    "bg-primary-500 font-semibold text-white hover:bg-primary-600 active:bg-primary-700",
  "soft-primary":
    "border border-primary-100 bg-primary-50 font-semibold text-primary-700 hover:border-primary-200 hover:bg-primary-100 active:bg-primary-100",
  secondary:
  ...
  danger: "bg-danger-muted font-semibold text-white hover:bg-danger active:bg-danger/90",
